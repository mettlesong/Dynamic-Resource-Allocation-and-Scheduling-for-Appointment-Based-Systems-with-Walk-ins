function [v_HS_simple,s_star_simple]=get_V_HS_simu_simple_linear(N,m,r,w,pd0_theta,pd1_theta,pi,theta)

%get_V_HS_simu_simple_linear is the same as get_V_HS_simple_linear except
%that demand is simulated
tic;
v_HS_simple=0;
